...
def SimulationStep():
  ...
  PposLat.set(value=str(math.degrees(FlyingThing.Lat))[0:8])
  PposLon.set(value=str(math.degrees(FlyingThing.Lon))[0:8])
  Speed = FlyingThing.VEW**2 + FlyingThing.VNS**2
  Speed = int(Speed ** .5/1852*3600)
  Gs.set(value=str(Speed) + "KTS")
  Hdg.set(value=str(int(math.degrees(FlyingThing.Hdg))) + ' °')
  if minor % 1000 == 0:
...
PposLat = tk.StringVar(master=home, value= "N 0.0".ljust(6,'0'))
PposLon = tk.StringVar(master=home, value="E 0.0".ljust(6,'0'))
Gs = tk.StringVar(master=home, value="0" + " KTS")
Hdg = tk.StringVar(master=home, value="0" + " °")
...
ProgressReport = tk.Frame(master=FplWorkArea)
PposFrame = tk.LabelFrame(master=ProgressReport, text="PRESENT POSITION", font=DefaultFontTuple)
PposFrame.grid(row=0,column=0, columnspan=2,padx=10, pady=10, sticky='news')
LblLat = tk.Label(master=PposFrame, textvariable=PposLat, font=NumericFontTuple)
LblLat.grid(row=0, column=0, padx=10, pady=0)
LblLon = tk.Label(master=PposFrame, textvariable=PposLon, font=NumericFontTuple)
LblLon.grid(row=0, column=1, padx=10, pady=0)
Fplprogress = tk.LabelFrame(master=ProgressReport, text= "PROGRESS", font=DefaultFontTuple)
Fplprogress.grid(row=3,column=0, columnspan=2, padx=10, pady=10, sticky='news')
LblTo = tk.Label(master=Fplprogress, text="TO", font=DefaultFontTuple, foreground='magenta')
LblTo.grid(row=0,column=0, padx=10, pady=10, sticky='w')
LblNext = tk.Label(master=Fplprogress, text="NEXT", font=DefaultFontTuple, foreground='black')
LblNext.grid(row=1,column=0, padx=10, pady=10, sticky='w')
LblDest = tk.Label(master=Fplprogress, text="DEST", font=DefaultFontTuple, foreground='black')
LblDest.grid(row=2,column=0, padx=10, pady=10, sticky='w')
GsDataFrame = tk.LabelFrame(master=ProgressReport, text= "GROUND SPEED", font=DefaultFontTuple)
GsDataFrame.grid(row=1,column=0, padx=10, pady=10)
LblGs = tk.Label(master=GsDataFrame, text="0 KT", font=NumericFontTuple, foreground='black', textvariable=Gs)
LblGs.grid(row=1,column=0, padx=10, pady=10)
HdgDataFrame = tk.LabelFrame(master=ProgressReport, text= "HEADING", font=DefaultFontTuple)
HdgDataFrame.grid(row=1,column=1, padx=10, pady=10)
LblHdg = tk.Label(master=HdgDataFrame, text="0 °", font=NumericFontTuple, foreground='black', textvariable=Hdg)
LblHdg.grid(row=2,column=0, padx=10, pady=10)
FplList = tk.Text(master=ProgressReport, width=70,state="disabled", font=DefaultFontTuple)
FplList.grid(row=0,column=2, rowspan=4, sticky="news")
FplWorkArea.add(ProgressReport, text="EDCU")
